...
const result = calcAllMoney(1000, 2000, 3000, 4000);
console.log(result);
...
// let powExpression = (numeric, powCount) => { return Array(powCount).fill(null).reduce(acc=>acc * numeric, 1); };

console.log(powExpression(2, 34));
...
console.log(repeat('Hi~ Hello~ ', 6));

let repeatExpreession = (text, repeatCount) => {
...
// let powExpression = (text, repeatCount) => { return Array(repeatCount).fill(null).reduce(acc=>acc * text, ''); };

console.log(repeatExpreession('Hi~ Hello~ ', 6));
